...
namespace Vacunacion.Controllers
{
    public class PeopleController : Controller
    {
        ...
        string role;
        public PeopleController(DB_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(Person person)
        {
            if (ModelState.IsValid)
            {
                ...
                if (userId.HasValue && userId > 0)
                {
                    ...
                    person.Status = "1"; // Establece el estatus en "1"
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonID,CI,Name,LastName,SecondLastName,Gender,Phone,Address,Status,RegisterDate,LastUpdate,UserId,Email")] Person person)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    // Aquí puedes usar 'person' en lugar de declarar una nueva variable
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (person != null)
            {
                ...
                // Puedes realizar otras acciones, como guardar un registro de auditoría, si es necesario.
